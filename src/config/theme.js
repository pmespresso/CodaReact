...
// blue
const primaryColor = '#03a6ff';
const primaryColorDark = '#0080ff';
const primaryColorLight = '#a3daff';
...
// Material Theme for Coda

const codaTheme = createMuiTheme({
  /* material variables */
  palette: {
    primary: {
